...
public final class LogsProto {
    ...
    static {
        ...
        internal_static_opentelemetry_proto_logs_v1_LogsData_descriptor = getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_opentelemetry_proto_logs_v1_ResourceLogs_descriptor = getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_opentelemetry_proto_logs_v1_ScopeLogs_descriptor = getDescriptor().getMessageTypes().get(2);
        ...
        internal_static_opentelemetry_proto_logs_v1_LogRecord_descriptor = getDescriptor().getMessageTypes().get(3);
